...
class AddCafeForm(FlaskForm):
    ...
    wifirating = SelectField('Wifi Strength Rating', choices=["🛰️", "🛰️🛰️", "🛰️🛰️🛰️", "🛰️🛰️🛰️🛰️", "🛰️🛰️🛰️🛰️🛰️"])
    powerrating = SelectField('Power Socket Availability', choices=["🔌", "🔌🔌", "🔌🔌🔌", "🔌🔌🔌🔌", "🔌🔌🔌🔌🔌"])
    submit = SubmitField('Submit')
...
def add_cafe():
    ...
    if form.validate_on_submit():
        with open('cafe-data.csv', newline='', encoding='utf8', mode='a') as csv_file:
            csv_file.write(f"{form.cafe.data},{form.location.data},{form.opentime.data},{form.closingtime.data},"
                           f"{form.coffeerating.data}, {form.wifirating.data}, {form.powerrating.data}")
    # Exercise:
